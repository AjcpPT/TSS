...
class ClamAVUpdater:
    ...
    def _run_update(self, on_progress, on_finished):
        ...
        # freshclam pode necessitar de sudo dependendo das permissões de /var/lib/clamav
        cmd =["freshclam"]
        ...
        try:
            ...
            if self._process.returncode == 0 or success or is_locked:
                ...
                msg = f"Erro ao atualizar. (Podes necessitar de correr a app com permissões administrativas). Código: {self._process.returncode}"
